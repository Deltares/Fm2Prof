...
class ARCHIVED_Test_extract_parameters:
    ...
    def test_when_parameters_are_given_then_maps_as_expected(
        ...
        # 3. Run test
        try:
            new_parameters = iniFile._extract_parameters(inifile_parameters)
        except:
            pytest.fail("Test failed while trying to extract parameters.")
        ...
        assert isinstance(retievedValue, numbers.Integral) == isinstance(
...
class ARCHIVED_Test_extract_output_dir:
    ...
    def test_when_given_parameters_then_gets_correct_path(
        self, param_output_dir_value, param_case_name_value, expected_value
    ):
        # 1. Set initial test data
        ini_file_path = None
        iniFile = IniFile(ini_file_path)
        ...
        parameter_list = {"outputdir": output_dir_value, "casename": case_name_value}
    ...
    def test_when_dirs_exist_then_returns_new_values(self):
        ...
        output_dir_list = []
        output_parameters = {"outputdir": output_dir, "casename": case_name}

        inifile_parameters = {"OutputDirectory": output_parameters}
...
class ARCHIVED_Test_readini_file:
    ...
    def test_when_inifile_contains_parameters_then_sets_them(self):
        ...
        for expected_input_param in expected_parameters:
            ...
            read_param_value = ini_file._parameters.get(expected_input_param)
    ...
    def test_when_inifile_is_not_valid_then_raises_exception(self):
        ...
        assert os.path.exists(ini_file_path), "Test file was not found."
        expected_error = (
            "It was not possible to extract ini parameters "
...
class ARCHIVED_Test_get_inifile_params:
    ...
    def test_when_given_valid_inifile_then_gets_expected_values(self):
        ...
        assert os.path.exists(ini_file_path), "Test file was not found."
        expected_section_zero = {"option_zero_zero": "string", "option_zero_one": "4.2"}
        expected_section_one = {"option_one_zero": "42", "option_one_two": "string"}
