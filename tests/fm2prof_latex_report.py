...
class Fm2ProfLatexReport(ReportContent):
    ...
    def authors_list(self) -> List[str]:
        return [
            'Koen Berends',
            'Asako Fujisaki',
            'Carles Salvador Soriano Perez']

    @property
    def case_description_dict(self) -> Dict[str, str]:
        return {
            'Case01rectangleKey':
                Fm2ProfLatexReport.case_01_rectangle_description(),
            'Case02compoundKey':
                Fm2ProfLatexReport.case_02_compound_description(),
            'Case03threestageKey':
                Fm2ProfLatexReport.case_03_three_stage_description(),
            'Case04storageKey':
                Fm2ProfLatexReport.case_04_storage_description(),
            'Case05dykeKey':
                Fm2ProfLatexReport.case_05_dyke_description(),
            'Case06plassenKey':
                Fm2ProfLatexReport.case_06_plassen_description(),
            'Case07triangularKey':
                Fm2ProfLatexReport.case_07_triangular_description(),
            'Case08waalKey':
                Fm2ProfLatexReport.case_08_waal_description(),
        }
