...
.. glossary::
    ...
    Cross-section location
        The cross-section location is defined in the :ref:`CrossSectionLocationFile`. 

    Total volume
        The Total volume refers to the volume of water [in m^3] within a :term:`Control volume` for a given water level at the :term:`Cross-section location`. The total volume is the sum of the :term:`Flow volume` and the :term:`Storage volume`. 

    Flow volume
        The Flow volume is defined as the volume of water [in m^3] for which the conditions for flowing water are met. This volume is considered to be available for the conveyance of water through the :term:`Control volume`. 

        See :ref:`distinguish_storage`
