...
class Test_extract_input_parameters:
    ...
    def test_when_parameters_are_given_then_maps_as_expected(self, value_as_string, expected_value):
        # 1. Set up initial test data
        iniFilePath = None
        iniFile = IniFile(iniFilePath)
...
class Test_extract_output_dir:
    ...
    def test_when_given_parameters_then_gets_correct_path(self, param_output_dir_value, param_case_name_value, expected_value):
        # 1. Set initial test data
        ini_file_path = None
        iniFile = IniFile(ini_file_path)
        new_output_dir_value = None
...
class Test_gets_valid_case_name:
    ...
    def test_when_given_valid_parameters_then_returns_expected_values(self, case_name, output_dir, expected_value):
        # 1. Set initial test data
        ini_file_path = None
        iniFile = IniFile(ini_file_path)
        new_case_name = None
...
class Test_get_valid_output_dir:
    ...
    def test_when_given_valid_parameters_then_returns_expected_values(self, output_dir, expected_value):
        # 1. Set initial test data
        ini_file_path = None
        iniFile = IniFile(ini_file_path)
        new_output_dir = None
