...
@pytest.mark.unittest
def test_extract_input_files_gets_filenames():
    # 1. Set up initial test data
    iniFilePath = None
    new_parameters = None
    iniFile = IniFile(iniFilePath)
...
def test_extract_output_dir_gets_correct_path(param_output_dir_value, param_case_name_value, expected_value):
    # 1. Set initial test data
    ini_file_path = None
    iniFile = IniFile(ini_file_path)
    new_output_dir_value = None
...
def test_get_valid_case_name_returns_expected_values(case_name, output_dir, expected_value):
    # 1. Set initial test data
    ini_file_path = None
    iniFile = IniFile(ini_file_path)
    new_case_name = None
...
def test_get_valid_output_dir_returns_expected_values(output_dir, expected_value):
    # 1. Set initial test data
    ini_file_path = None
    iniFile = IniFile(ini_file_path)
    new_output_dir = None
...
@pytest.mark.unittest
def test_get_valid_output_dir_when_no_output_dir_returns_current_path():
    # 1. Set initial test data
    ini_file_path = None
    iniFile = IniFile(ini_file_path)
    new_output_dir = None
...
def test_read_ini_file_sets_output_dir():
    # 1. Set initial test data
...
@pytest.mark.systemtest
def test_read_ini_file_sets_input_parameters():
    # 1. Set initial test data
    test_data_dir = TestUtils.get_test_data_dir('IniFile')
    ini_file_path = os.path.join(test_data_dir, 'valid_ini_file.ini')
...
@pytest.mark.systemtest
def test_read_ini_file_sets_input_file_paths():
    # 1. Set initial test data
    test_data_dir = TestUtils.get_test_data_dir('IniFile')
    ini_file_path = os.path.join(test_data_dir, 'valid_ini_file.ini')
